...
export function Navigation({ currentPage, onNavigate }: NavigationProps) {
  ...
  const menuItems = [
    ...
    { id: "sfe" as const, label: "顺风耳 三体人", badge: "新品" },
  ];
          ...
          <div className="hidden md:flex items-center gap-2">
            {menuItems.map((item) => (
              <button
                ...
                className={`relative px-2 py-2 rounded-lg transition-all whitespace-nowrap text-base ${(item.id === "home" && isHomePage) ||
                  (item.id === "cad" && isCadPage) ||
                  (item.id === "window" && isWindowPage) ||
                  (item.id === "xrf" && isXRFPage) ||
                  (item.id === "ll" && isLLPage) ||
                  (item.id === "sfe" && isSFEPage)
                  ? "text-blue-600"
          ...
          >
            {menuItems.map((item) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-lg transition-all flex items-center justify-between ${(item.id === "home" && isHomePage) ||
                  (item.id === "cad" && isCadPage) ||
                  (item.id === "window" && isWindowPage) ||
                  (item.id === "xrf" && isXRFPage) ||
                  (item.id === "ll" && isLLPage) ||
