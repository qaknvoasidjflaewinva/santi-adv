...
export function SFEPricingSection() {
            ...
            >
              ...
              >
                ...
                <div className="text-center mb-6">
                  <Badge className={`${tier.badgeColor} text-white mb-3`}>
                    {tier.badge}
                  </Badge>
                  <div className="flex items-center justify-center gap-2 mb-2">
                    <Calendar className="w-5 h-5 text-gray-600" />
                    <h3 className="text-xl text-gray-900">{tier.period}</h3>
                  </div>
                  <div className="mt-4">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 text-left">
            <div>
              ...
              <p className="text-blue-100">最高优惠幅度，首购仅需200元</p>
            </div>
            <div>
              <div className="text-3xl mb-2">+300元</div>
              <p className="text-blue-100">晚购比早购多花300元，机会成本高</p>
            </div>
            <div>
